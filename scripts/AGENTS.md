...
- `bench_cfr_iterator_spots.py`: Profiles eager sparse/fused-sparse CFR iterator segments from evenly balanced saved spots across preflop/flop/turn/river roots.
