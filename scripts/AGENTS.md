...
- `bench_preflop_evaluate_cfr_loop.py`: Benchmarks the production compact preflop `evaluate_cfr` solve loop on the current actions_4_7 shape, including CUDA-graph on/off comparisons and optional preflop backward-induction process-group pause/resume handling.
