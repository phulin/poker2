...
LR_TAG=${LR_TAG:-lr004}
CHECKPOINT_DIR=${CHECKPOINT_DIR:-checkpoints-rebel-curriculum-sapcfr-80-40-300it-8000-val-ctx41-live-board96-belief128-r96-canonical-k32-out0-${LR_TAG}-random-wandb}
WANDB_NAME=${WANDB_NAME:-river_sapcfr_80_40_300it_8000_val_ctx41_live_board96_belief128_r96_canonical_k32_out0_${LR_TAG}_random}
