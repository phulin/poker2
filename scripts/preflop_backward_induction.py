...
def _add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--sparse-fused", action=argparse.BooleanOptionalAction, default=True
    )
    parser.add_argument(
        "--compile", default=None, choices=["off", "default", "max-autotune"]
    )
    parser.add_argument(
        "--belief-mode", default="random", choices=["random", "uniform"]
    )
    ...
    parser.add_argument(
        "--actions-12-15-cfr-batch-size",
        type=int,
        default=None,
        help="Override --cfr-batch-size for the actions_12_15 specialist.",
    )
    parser.add_argument(
        "--actions-8-11-cfr-batch-size",
        type=int,
        default=None,
        help="Override --cfr-batch-size for the actions_8_11 specialist.",
    )
    parser.add_argument("--actions-12-15-epochs", type=int, default=1)
    parser.add_argument("--validation-items", type=int, default=4096)
    parser.add_argument("--validation-cfr-iterations", type=int, default=10_000)
    ...
    parser.add_argument(
        "--wandb-project", default="poker-rebel-preflop-backward-induction"
    )
    parser.add_argument("--wandb-name", default=None)
    parser.add_argument("--wandb-group", default=None)
    parser.add_argument(
        "--wandb-tags", nargs="*", default=["preflop", "backward-induction"]
    )
