...
def check_advantages():
    ...
    print(f"Advantages - min: {min(all_advantages):.3f}, max: {max(all_advantages):.3f}, mean: {sum(all_advantages)/len(all_advantages):.3f}")
    print(f"Returns - min: {min(all_returns):.3f}, max: {max(all_returns):.3f}, mean: {sum(all_returns)/len(all_returns):.3f}")
