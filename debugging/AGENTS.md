...
- `debug_pre_chance_transition.py`: Pre-chance transition debugging.
...
- `profile_cfr_iteration.py`: Single CFR iteration profiling.
- `profile_cfr_trainer.py`: CFR trainer profiling.
- `profile_comprehensive.py`: Comprehensive profiling script.
