...
def compare_ppo_losses():
    ...
    # Compare
    print(f"\nComparison:")
    print(f"  Loss difference: {trinal_loss['total_loss'].item() - standard_loss['total_loss'].item():+.6f}")
    print(f"  Ratio mean difference: {trinal_loss['ratio_mean'].item() - standard_loss['ratio_mean'].item():+.3f}")
