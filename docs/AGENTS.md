...
- `rebel_pregenerated_postflop_curriculum_plan.md`: Plan for converting the main heads-up postflop ReBeL loop from live data generation to offline solved-example datasets, bootstrapping river to turn to flop and connecting later to multiway preflop handoff roots.
