...
- `split_checkpoint_fixture.test.ts`: Loads the committed `rebel_296_4000` split checkpoint/export fixture and checks selected WebGPU policy/value outputs against PyTorch.
