...
- `preflop_buckets.py`: Single typed execution-config boundary plus run-config build helpers for preflop backward-induction bucket stages, including compact preflop-safe model overrides and checkpoint resume wiring.
