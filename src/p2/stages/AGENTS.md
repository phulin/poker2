...
- `preflop_backward_induction.py`: Packaged implementation of preflop depth-bucket specialist training and distillation, including state-bucket reading, validation caches, separate CFR solve and supervised train batching, solve/train loops, and checkpoint summaries.
