...
- `better_ffn.py`: Residual feed-forward Better models, including the legacy combined model plus split `BetterPolicyFFN`, `BetterStreetValueFFN`, and `BetterSplitFFN` wrapper with static feature-base helpers and optional low-rank rank/suit board interactions.
