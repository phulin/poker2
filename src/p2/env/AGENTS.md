...
- `card_utils.py`: 1326-combo lookup, 169-class preflop mapping/expand/collapse helpers, exact preflop class compatibility and unblocked-mass projection, board masks, suit permutations, canonical flop representatives with orbit weights, blockers, and unblocked-mass helpers.
