#!/usr/bin/env python3
"""
Training script for P2 with K-Best self-play.
...
from p2.rl.fixed_opponent_pool import FixedOpponentPool
...
def train_kbest(cfg: Config) -> SelfPlayTrainer:
    """
    Train agent using K-Best self-play with optional exploiter training.
