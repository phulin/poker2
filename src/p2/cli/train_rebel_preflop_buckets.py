...
def _execution_config_from_config(cfg: Config) -> PreflopBucketExecutionConfig:
    ...
    return PreflopBucketExecutionConfig(
        ...
        seed=cfg.seed,
        depth=preflop.depth,
        actions_12_15_depth=preflop.actions_12_15_depth,
        actions_8_11_depth=preflop.actions_8_11_depth,
        actions_4_7_depth=preflop.actions_4_7_depth,
        actions_0_3_depth=preflop.actions_0_3_depth,
        ...
        belief_profile=preflop.belief_profile,
        belief_hand_dim=preflop.belief_hand_dim,
        ...
        cfr_model_batch_size=preflop.cfr_model_batch_size,
