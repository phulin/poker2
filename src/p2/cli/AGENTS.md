...
- `train_rebel_curriculum.py`: Hydra entry point for staged postflop ReBeL curriculum training; converts structured config and delegates implementation to `p2.stages.curriculum`.
