...
- `structured_config.py`: Dataclass-based Hydra config schema and enums for training, model, environment, search, data-source, curriculum, pregeneration, and rating options.
