...
- `optimizers.py`: Optimizer construction helpers, including optional Muon or NorMuon matrix optimization with AdamW fallback splitting for ReBeL/all-in training and split BetterFFN policy-head grouping.
