...
from p2.core.structured_config import Config, KLType, LrSchedule, ValueHeadType
...
from p2.models.transformer.kv_cache_manager import SelfPlayKVCacheManager
...
from p2.rl.dred_pool import DREDPool
from p2.rl.exponential_controller import ExponentialController
from p2.rl.k_best_pool import KBestOpponentPool
from p2.rl.losses import CFRDistillationLoss, KLPolicyPPOLoss
from p2.rl.opponent_pool import OpponentPool
from p2.rl.popart_normalizer import PopArtNormalizer
from p2.rl.replay import Trajectory, Transition
from p2.rl.vectorized_replay import BatchSample, VectorizedReplayBuffer
...
class SelfPlayTrainer:
    ...
    def __init__(self, cfg: Config, device: torch.device):
        ...
        if self.cfg.search.enabled:
            self.loss_calculator = CFRDistillationLoss(
        ...
        if pool_data is not None:
            ...
            for snapshot_data in pool_data.get("snapshots", []):
                ...
                if "dred_age" in snapshot_data:
                    from p2.rl.dred_pool import DREDSnapshotData
