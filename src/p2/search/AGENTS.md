...
- `postflop_spot_sampler.py`: Random legal postflop public-root samplers for heads-up flop/turn/river street-start roots, closed-street chance-target roots, texture-stratified boards, tensorized strength-ordered and named-shape board-legal belief mixtures, and conservative pot/SPR templates.
