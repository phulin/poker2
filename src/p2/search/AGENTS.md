...
### Source files
- `cfr_evaluator.py`: PublicBeliefState, exploitability stats, hand-rank data, evaluator interface, shared split policy/value model dispatch, optional closing-leaf value model routing, and per-root leaf target-source provenance.
