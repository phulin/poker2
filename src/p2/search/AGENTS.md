...
- `fused_preflop_sparse_cfr_evaluator.py`: CUDA/Triton-backed preflop sparse evaluator boundary with multiway fused EV/regret, average-policy/value update, and model-writeback kernels plus reference PBSEnv construction.
