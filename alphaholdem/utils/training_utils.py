...
def print_preflop_range_grid(trainer, step: int, seat: int = 0, title: Optional[str] = None):
    """
...
def print_training_stats(stats: dict, step: int, total_steps: int, step_time: str, total_time: str):
    """
