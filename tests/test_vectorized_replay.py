...
class TestVectorizedReplayBuffer:
    ...
    def test_transformer_add_transitions_appends_context_and_action(self, buffer):
        ...
        buffer.add_transitions(
            ...
            logits=torch.zeros(1, buffer.num_bet_bins, device=device),
    ...
    def _create_test_batch(self, batch_size: int, device: torch.device) -> dict:
        ...
        return {
            ...
            "logits": torch.randn(batch_size, B, device=device),
    ...
    def _create_test_batch_complete(
        ...
        return {
            ...
            "logits": torch.randn(batch_size, trajectory_length, device=device),
