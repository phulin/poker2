...
- `test_pregenerate_postflop_rebel.py`: Bounded postflop pregeneration CLI coverage for live-mode validation, trimmed solved-batch writer calls, root-street metadata, quality metadata, and closing-leaf/distillation-source checkpoint provenance.
