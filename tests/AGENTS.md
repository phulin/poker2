...
- `test_rebel_data_source.py`: ReBeL data-source abstraction coverage for live generator-backed and pregenerated solved-dataset-backed training data, including pregenerated step windows, shuffled sampling, and direct dataset sampling.
